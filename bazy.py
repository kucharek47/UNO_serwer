...
def inicjalizuj_baze():
    zapytania = [
        ...
        (
            ...
            aktualny_kolor VARCHAR
        (
            15
        ),
            kara INT DEFAULT 0,
            ile_stopow INT DEFAULT 0,
            aktywne_combo VARCHAR
        (
            10
        ),
        ...
        (
            ...
            gracz_id INT REFERENCES gracze
        (
            id
        )
          ON DELETE CASCADE,
...
def pobierz_stan_dla_tokenu(token):
    with engine.connect() as conn:
        ...
        return {
            ...
            "karty": [{"gracz_id": k[0], "lokalizacja": k[1], "pozycja": k[2], "kolor": k[3], "wartosc": k[4]} for k in
                      karty],
            "gracze": [
                {"id": g[0], "numer_w_pokoju": g[1], "czy_bot": g[2], "zglasza_uno": g[3], "pominiete_tury": g[4]} for g
                in gracze]
        }
...
def pobierz_graczy(pokoj_id):
    with engine.connect() as conn:
        ...
        return [{"id": g[0], "numer_w_pokoju": g[1], "czy_bot": g[2], "zglasza_uno": g[3], "pominiete_tury": g[4]} for g
                in wynik]
...
def pobierz_karty(pokoj_id):
    with engine.connect() as conn:
        ...
        return [{"id": k[0], "gracz_id": k[1], "lokalizacja": k[2], "pozycja": k[3], "kolor": k[4], "wartosc": k[5]} for
                k in wynik]
